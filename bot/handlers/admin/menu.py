...
class AdminCourtsMenu(Handler):
    ...
    async def _process(self) -> None:
        ...
        await self._update.callback_query.edit_message_text(
            msgs.admin_courts_menu(count=len(courts)),
            reply_markup=InlineKeyboardMarkup(
                [
...
class AdminTrainersMenu(Handler):
    ...
    async def _process(self) -> None:
        ...
        await self._update.callback_query.edit_message_text(
            msgs.admin_trainers_menu(count=len(trainers)),
            reply_markup=InlineKeyboardMarkup(
                [
...
class AdminLocationsMenu(Handler):
    ...
    async def _process(self) -> None:
        ...
        await self._update.callback_query.edit_message_text(
            msgs.admin_locations_menu(count=len(locations)),
            reply_markup=InlineKeyboardMarkup(
                [
