...
from bot.handlers.callback_args import AdminEditStudentArg
            ...
            keyboard.append(
                [
                    InlineKeyboardButton(
                        button_text,
                        callback_data=AdminEditStudentArg(id=student.id).to_callback_data(),
                    ),
                ],
            )
        keyboard.append([InlineKeyboardButton(self._messages.btn_back, callback_data='admin_students')])
        await self._update.callback_query.edit_message_text(
            self._messages.admin_student_select_to_edit,
