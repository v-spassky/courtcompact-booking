...
async def _handle_admin_delete_trainer_list(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.callback_query.edit_message_text(msgs.admin_trainer_select_to_delete, reply_markup=reply_markup)
