...
from bot.handlers.callback_args import AdminConfirmDeleteLocationArg, AdminDeleteLocationArg
                ...
                [
                    [
                        InlineKeyboardButton(
                            ...
                            callback_data=AdminConfirmDeleteLocationArg(id=location.id).to_callback_data(),
                        ),
                    ],
